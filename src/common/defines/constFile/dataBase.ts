...
export const URINE_LOW_POWER_CLASS_IDS = [CLASS_INFO_ID.WBC, CLASS_INFO_ID.YEAST];

export const URINE_HIGH_POWER_CLASS_IDS = [CLASS_INFO_ID.GPC, CLASS_INFO_ID.GNB, CLASS_INFO_ID.GPB];
